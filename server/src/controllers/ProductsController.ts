...
export class ProductsController {
  ...
  async index(request: Request, response: Response) {
    ...
    const payment_methods = request.query.payment_methods === undefined ? undefined : typeof request.query.payment_methods === 'string' ? [request.query.payment_methods] : request.query.payment_methods as string[]
